    ...
    public class ReportingController : Controller
    {
        ...
        public ActionResult PeriodictIncomeReport(ProductViewModel productViewModel)
        {
            ...
            foreach(var saleProduct in salesProducts)
            {
                ...
                float saleDiscountPercent = _reportingManager.GetSalesDiscountPercentByDate(saleProduct.SaleId);
                decimal discountPercent =(decimal) saleDiscountPercent;
                //decimal saleDiscountPercent = 0;
                model.SalesPrice = product.PreviousMRP * saleProduct.Quantity;
                decimal discountAmount = (model.SalesPrice * discountPercent) / 100;
